package automationtestproject.utilities;
...
public class PropertyManager {
    ...
    public PropertyManager() {
        try {
            ...
            this.fileConfig = getClass().getClassLoader()
                    .getResourceAsStream("propertiesFile/config.properties");
    ...
    /**
     * getInstance --> Check If the instance is null, if not returns existing
     * else new instance of PropertyManager
     *
    ...
    /**
     * valueFromConfig return value from CONFIG properties if value from
     * environment is null.
     *
    ...
    public String valueFromConfig(String key) {
        ...
        // Checking if value from Environment variable is null, if it is null
        // then
        ...
        try {
            ...
            System.out.println(
                    "Error while getting value from config/environment because of :-"
                            + e);
        }
